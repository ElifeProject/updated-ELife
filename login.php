                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        <form action="login.php" method="post" >
                                            ...
                                            <div class="form-group">
                                                <label for="name"><div class="font-clr">Username:</div></label>
                                                <input type="" class="form-control" id="" placeholder="Enter username" name="username" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                 <button  type="submit" class="btn btn-default" name="login_btn">Log In</button>
                                            </div>
