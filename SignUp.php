                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        <form action="SignUp.php" name="SignUp" method="post">
                                            ...
                                            <div class="form-group">
                                                <label ><div class="font-clr">Username:</div></label>
                                                <input type="text" name="username" value="<?php echo $username; ?>" class="form-control" id="" placeholder="Enter  username" name="" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="email"><div class="font-clr">Email:</div></label>
                                                <input type="email" name="email"  value="<?php echo $email; ?>" class="form-control" id="" placeholder="Enter Email" name="" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="password"><div class="font-clr">Password:</div></label>
                                                <input type="password"  name="password_1" class="form-control" id="" placeholder="Enter password" name="" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="password"><div class="font-clr">Confirm Password</div></label>
                                                <input type="password"  name="password_2" class="form-control" id="" placeholder="Confirm password" name="" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <br>
                                            <button type="submit" value="signup"  name="SignUp_btn" class="btn btn-default">Create Account</button>
                                        </form>
                                        <br>
